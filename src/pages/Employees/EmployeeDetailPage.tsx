...
import { DEPARTMENTS, mockUsers, ROLES, STATUSES } from '../../data/users'
...
export default function EmployeeDetailPage() {
  ...
  // Find user or fallback to mock user
  const user = mockUsers.find((u) => u.id === Number(id)) ?? mockUsers[1]
        ...
        <Card.Content className='px-6 pb-6 pt-0 relative'>
          ...
          <div className='grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-slate-100 text-sm'>
            ...
            <div>
              ...
              <span className='font-semibold text-emerald-600'>{formatCurrency(user.salary)}</span>
            </div>
            <div>
